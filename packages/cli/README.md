...
The single-binary install / configure / run / diagnose surface for Coodra, the MCP server platform that gives AI coding agents (Claude Code, Codex, Cursor) Feature Packs, Context Packs, and policy enforcement.

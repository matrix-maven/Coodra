...
/**
 * `packages/lifecycle/src/auto-context-pack.ts` — Context Pack
 * auto-save invoked from SessionEnd finalization
 * (decision dec_83ba10c1, 2026-05-02 — Pattern 20). Extracted from
 * `apps/hooks-bridge` in Phase 1 of the bridge retirement; the bridge
 * itself was deleted in COOD-67.
 *
...
const autoContextPackLogger = createLogger('lifecycle.auto-context-pack');
 ...
 * "## Diff" section in the auto-context-pack body. The run-diff runner
 * (./run-diff-runner.ts) writes this row before
